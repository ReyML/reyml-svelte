<footer class='border-t-2 border-gray-900 h-16 bottom-0 left-0 right-0 relative flex justify-center flex-col gap-2 items-center flex-wrap w-full'>
    <div class=' text-center flex justify-center items-center text-slate-100'>
        <p>&copy; 2022 Reyml</p>
    </div>
    <div class='flex flex-row gap-2'>
        <a href="https://twitter.com/_illidari" target="_blank">
        ...
        <a href="https://github.com/ReyML" target="_blank">
        ...
        <a href="https://t.me/Musashi_M" target="_blank">
