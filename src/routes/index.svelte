    ...
    <div class="flex flex-col gap-y-5 -translate-y-4">   
      <div class="max-w-sm md:max-w-lg mx-12 py-4 px-8 z-50 shadow-lg shadow-blue-800 rounded-lg my-20">
        ...
        <div class="tracking-wider ">
          ...
          <p class="mt-2 text-gray-300">I build front-end libraries at Algolia and host the Developer Experience podcast. I can't shut up about test-driven development and utility-first CSS. I also share what I learn on my blog and in conferences around the world!</p>
        </div>
      </div>
    </div>
  </div>
